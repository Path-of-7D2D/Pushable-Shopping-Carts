...
{
    /// <summary>
    /// While the local player is pushing a shopping cart, restrict their input the way
    ...
    internal static class PushLock
    {
        ...
        {
            return player != null && PushableShoppingCartsPush.ShouldLockLocalPlayer(player);
        }
    }
